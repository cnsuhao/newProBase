				  ...
				  )
{
	...
	unsigned int sum_b;
	unsigned int sum_a;
	unsigned int sum_in_r;
	unsigned int sum_in_g;
	unsigned int sum_in_b;
	unsigned int sum_in_a;
	unsigned int sum_out_r;
	unsigned int sum_out_g;
	unsigned int sum_out_b;
	unsigned int sum_out_a;
